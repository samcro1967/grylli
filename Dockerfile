...
# Minify JS and build CSS (exclude critical CSS build to avoid Puppeteer crash)
RUN npx terser app/static/js/application.js -o app/static/js/application.min.js --compress --mangle && \
    npm run build:css && \
