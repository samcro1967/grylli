...
def set_locale_post():
    ...
    try:
        ...
        return redirect(get_safe_redirect(request.referrer, fallback_endpoint="index.index"))
...
def set_language(lang_code):
    ...
    try:
        ...
        redirect_url = get_safe_redirect(request.referrer, fallback_endpoint="index.index")
