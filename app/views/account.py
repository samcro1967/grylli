    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            if updated_fields:
                ...
                log_info_message(f"User '{current_user.username}' clicked save with no changes.")
...
def set_security_questions():
    ...
    try:
        ...
        log_info_message(f"User '{current_user.username}' set or updated their security questions.")
        return render_template(template, form=form)
