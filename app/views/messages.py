...
def overview():
    ...
    try:
        ...
        return redirect(url_for("home.index"))  # ✅ still correct unless you've renamed the index blueprint
...
def create_message():
    ...
    template = "messages/create_message_partial.html" if request.headers.get("HX-Request") else "messages/create_message_full.html"
