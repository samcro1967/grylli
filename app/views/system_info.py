...
def index():
    ...
    try:
        ...
        if os.path.exists(version_json_path):
            ...
            stack["Node.js"] = "Unavailable"
            stack["npm"] = "Unavailable"
            log_info_message("Frontend version.json not found. Node.js/npm versions set to 'Unavailable'.")

        template = "system_info_partial.html" if request.headers.get("HX-Request") else "system_info_full.html"
