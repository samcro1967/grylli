...
from app.views.tasks import bp as tasks
...
def register_blueprints(app):
    ...
    _r(locale.bp, prefix)
    _r(admin, prefix)
    _r(logs_bp, f"{prefix}/admin/logs")
    _r(account, prefix)
    _r(index, prefix)
    _r(auth, prefix)
    _r(about, prefix)
    ...
    _r(system_settings, f"{prefix}/admin/system_settings")
    _r(backups, f"{prefix}/admin/backups")
    _r(smtp_settings_admin, f"{prefix}/admin/smtp-settings")
