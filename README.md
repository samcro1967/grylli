...
- [Features](#features)
  ...
  - [🛠️ Admin Tasks](#️-admin-tasks)
  - [📈 Admin Reports](#-admin-reports)
  - [🛡️ Security & Production Readiness](#️-security--production-readiness)
  - [🛡️ Application Trust Model](#️-application-trust-model)
...
- Table/Card view preference is saved per module via localStorage for persistent view selection (e.g., Notifications, Users)
...
- Progressive Web App (PWA) support: installable manifest, service worker registration, offline metadata caching, and mobile/desktop home screen integration
...
- Currently available reports:
  ...
  - **Scheduler Activity**: Displays execution history for scheduled items (reminders, emails, notifications)
...
**Total Coverage**: **78%**
(4017 statements, 893 currently not covered)
